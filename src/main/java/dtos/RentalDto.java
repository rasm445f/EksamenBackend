...
//    @NotNull
//    private final HouseDto houseID;
//
//    public RentalDto(Integer id, String startDate, String endDate, String priceAnnual, String deposit, HouseDto houseID) {
//        this.id = id;
//        this.startDate = startDate;
//        this.endDate = endDate;
//        this.priceAnnual = priceAnnual;
...
//        this.priceAnnual = rental.getPriceAnnual();
//        this.deposit = rental.getDeposit();
//        this.houseID = new HouseDto(rental.getHouseID().getId(), rental.getHouseID().getAddress(), rental.getHouseID().getCity(), rental.getHouseID().getNumberOfRooms());
//    }
//
//    public static List<RentalDto> getRentalDtos(List<Rental> rentals) {
//        List<RentalDto> RentalDtoList = new ArrayList<>();
...
//        return new Rental(startDate,endDate,priceAnnual,deposit,tenants);
//    }
//}