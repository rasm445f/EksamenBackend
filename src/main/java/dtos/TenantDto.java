...
//
//    public TenantDto(Integer id, String tenantName, String tenantJob) {
//        this.id = id;
...
//        tenants.forEach(tenant -> {
//            TenantDtoList.add(new TenantDto(tenant));
//        });
...
//    @Override
//    public int hashCode() {
//        return Objects.hash(id, tenantName, tenantJob);
//    }
//
//    @Override
//    public String toString() {
...
//        return new Tenant(tenantName, tenantJob);
//    }
//}